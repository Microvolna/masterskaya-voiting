	...
	var t = {
		...
		a = function(t, n) {
			...
			return document.querySelectorAll(t)
				.length ? document.querySelectorAll(t) : !1
		}, s = function(t) {
				...
				n.forEach(function(n) {
					...
					if (o) {
						var s = Q(i, n.name, n.value, u),
							c = m(n);
						c.animatables = a, c.type = o, c.round = r.color(s.from) ? !0 : c.round, c.delay = (r.func(c.delay) ? c.delay(u, t.length) : c.delay) / c.speed, c.duration = (r.func(c.duration) ? c.duration(u, t.length) : c.duration) / c.speed, c.from = D(n.name, s, c.type, i)
							.from, c.to = D(n.name, s, c.type, i)
							.to, e.push(c)
					}
				})
			}), e
